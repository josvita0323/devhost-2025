        ...
        {events.map((event, idx) => {
          ...
          return (
            <motion.div
              ...
              className="event-card relative mx-auto aspect-[7/5] w-full max-w-[700px] lg:max-w-[700px]"
            >
              <Image
                src="/Group2010.svg"
                alt="Card Background"
              ...
              <div className="absolute inset-0 flex flex-row gap-4 p-[8%] lg:p-[9%]">
                ...
                <div className="flex flex-1 flex-col justify-between overflow-hidden py-1 sm:py-7">
                  <div className="flex-1 overflow-y-auto pr-1 text-left">
                    <motion.h2 className="mb-6 text-center text-lg leading-tight font-bold text-[#a3ff12] lg:text-2xl">
                      {event.title}
                    </motion.h2>
                  ...
                  {!noRegister && (
                    <motion.div className="font-orbitron flex justify-center gap-4">
                      <button
                        className="bg-primary relative mt-4 flex cursor-pointer items-center gap-4 px-5 py-2 text-xs font-bold tracking-widest text-black uppercase transition"
                        style={{
                          clipPath:
