...
export default function AboutDevhost() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-6 left-6 font-mono text-sm font-bold text-black opacity-80">
        // DEVHOST
      </div>
      <div className="absolute top-6 right-6 font-mono text-sm font-bold text-black opacity-80">
        2025
      </div>
      <div className="absolute right-6 bottom-6 origin-bottom-right -rotate-90 font-mono text-xs font-bold text-black opacity-60">
        ADAPTIVE MOBILE
      </div>
