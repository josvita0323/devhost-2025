              ...
              <div className="pb-5">
                ...
                <div className="flex mt-4 space-x-4">
                  <Link
                    ...
                    target="_blank"
                    className="text-gray-300 hover:text-white transition-colors duration-200 hover:drop-shadow-[0_0_8px_rgba(180,255,57,0.8)]"
                  >
                ...
                <ul className="flex flex-col gap-4 text-gray-300 font-medium">
                  <li>
                    <Link
                      ...
                      target="_blank"
                      className="underlined_link hover:text-[#B4FF39] hover:drop-shadow-[0_0_5px_#B4FF39] transition-colors duration-200"
                    >
                      Website
                    </Link>
                  </li>
